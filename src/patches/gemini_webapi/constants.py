...
class Model(Enum):
    ...
    G_2_5_PRO = (
        "gemini-2.5-pro",
        {
            "x-goog-ext-525001261-jspb": '[1,null,null,null,"4af6c7f5da75d65d",null,null,0,[4],null,null,1]'
        },
        False,
    )
    G_2_5_FLASH = (
        "gemini-2.5-flash",
        {
            "x-goog-ext-525001261-jspb": '[1,null,null,null,"9ec249fc9ad08861",null,null,0,[4],null,null,1]'
        },
        False,
    )
